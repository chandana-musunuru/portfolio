          ...
          if (section === 'Experience') {
            return (
              <section
                key={section}
                id="experience"
                className="min-h-[80vh] bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-white px-0 py-16 flex items-start justify-center"
              >
                <div className="w-full max-w-7xl flex">
                  {/* Left-aligned heading */}
                  <div className="w-[20%] flex items-start justify-start pl-6">
                  ...
                  {/* Right content area */}
                  <div className="w-[80%] pr-6 space-y-1">
                    {/* Experience Card */}
                    <div className="bg-blue-400 dark:bg-gray-700 p-8 rounded-lg shadow-lg transition">
